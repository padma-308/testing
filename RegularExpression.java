...
public class RegularExpression {
	...
	public static void main(String[] args) {
		...
		WebElement we = driver.findElement(By.xpath("//*[@id='u_0_6']"));
		...
		/*String reqx = "female";
		if(reqx.matches("driver.findElement(By xpath("/html/body/div[1]/div[3]/div[1]/div/div/div[2]/div/div/div[1]/form/div[1]/div[6]/span/span[1]/input"))"));
